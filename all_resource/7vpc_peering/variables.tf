...
variable "detroit_vpc_public_route_table" {}
variable "detroit_vpc_private_route_table" {}
...
variable "chicago_vpc_public_route_table" {}
variable "chicago_vpc_private_route_table" {}